...
motif_list <- motif_list[-c(136,137),]


for (idx in 1:nrow(motif_list)){
  ...
  list_tests <- perform_tests(c(motif_name = name, motif = motif),
                              c("five_prime_utr", "CDS", "three_prime_utr", "5UTR-CDS", "5UTR_start30"),
                              "rna-binding_protein_mrna_motif",
                              gene_set = gene_set,
                              dir_out = paste0("2024.emt.rprof/", name),
...
################################################################################
########### Extra motif manually
################################################################################

name = "CU-box"
list_tests <- perform_tests(c(motif_name = "CU-box", motif = "SCTSYSW"), c("five_prime_utr", "CDS", "three_prime_utr", "5UTR-CDS", "5UTR_start30"), 
                            "rna-binding_protein_mrna_motif", gene_set = gene_set, 
                            dir_out = "2024.emt.rprof/CU_box", fname_prefix = "emt.rprof.CU_box")


list_out <- get_heatmap(list_tests$tmat, vec_color_group = NULL, type_col = "dlog10p",
                        #row_pattern="^(?!.*translationONLY.*)",
                        col = colorRamp2(c(-5,-1,0,1,5),c("#0000ff", "#ffffcc", "#ffffcc", "#ffffcc", "#ff0000")),
                        cluster_rows = T, column_title='CU_box',
                        fontsize_row_names=9, fontsize_column_names=9, column_name_angle=50)
...
list_tests <- perform_tests(c(motif_name = "TISU", motif = "SAAGATGGCGGC"), c("five_prime_utr", "CDS", "5UTR-CDS", "three_prime_utr", "5UTR_start30"), "rna-binding_protein_mrna_motif",
                            gene_set = gene_set, dir_out = "2024.emt.rprof/TISU", fname_prefix = "emt.rprof.TISU")
#list_tests$tdf
...
## CGAGG motif
list_tests <- perform_tests(c(motif_name = "GGAGG", motif = "GGAGG"), c("five_prime_utr", "CDS", "three_prime_utr", "5UTR-CDS", "5UTR_start30"), "rna-binding_protein_mrna_motif",
                            gene_set = gene_set, dir_out = "2024.emt.rprof/GGAGG", fname_prefix = "emt.rprof.GGAGG")
#list_tests$tdf
...
list_tests <- perform_tests(c(motif_name = "GGC-rich", motif = "GCGGCGGCGGCG"), c("five_prime_utr", "CDS", "three_prime_utr", "5UTR-CDS", "5UTR_start30"), 
                            "rna-binding_protein_mrna_motif", gene_set = gene_set,
                            dir_out = "2024.emt.rprof/GGC-rich", fname_prefix = "emt.rprof.GGC-rich")
#list_tests$tdf
...
list_tests <- perform_tests(c(motif_name = "TOP-motif", motif = "CTCTTCC"), c("five_prime_utr", "CDS", "three_prime_utr", "5UTR-CDS", "5UTR_start30"), 
                            "rna-binding_protein_mrna_motif", gene_set = gene_set,
                            dir_out = "2024.emt.rprof/TOP-motif", fname_prefix = "emt.rprof.TOP-motif")
#list_tests$tdf
...
#https://hugheslab.ccbr.utoronto.ca/supplementary-data/RNAcompete_eukarya/RBPDB_motifs.txt

# KAACAUCU	115_7499328.pwm	115_7499328.pfm
# UAACAUC	114_7499328.pwm	114_7499328.pfm
# GCCANACCAYCGC	

list_tests <- perform_tests(c(motif_name = "YBX2A-motif", motif = "KAACATCT"), c("five_prime_utr", "CDS", "three_prime_utr", "5UTR-CDS", "5UTR_start30"),
                            "rna-binding_protein_mrna_motif", gene_set = gene_set,
                            dir_out = "2024.emt.rprof/YBX2A-motif", fname_prefix = "emt.rprof.YBX2A-motif")
#list_tests$tdf
list_out <- get_heatmap(list_tests$tmat, vec_color_group = NULL, type_col = "dlog10p",
                        #row_pattern="^(?!.*translationONLY.*)",
                        col = colorRamp2(c(-5,-1,0,1,5),c("#0000ff", "#ffffcc", "#ffffcc", "#ffffcc", "#ff0000")),
                        cluster_rows = T, column_title='YBX2A-motif',
                        fontsize_row_names=9, fontsize_column_names=9, column_name_angle=50)
fname  <-  sprintf("YBX2A-motif_%s", list_out$type_col_short )
print_figure(list_out$list_ht, width = 4.25, height = 2.5, file = fname)
...
list_tests <- perform_tests(c(motif_name = "YBX2B-motif", motif = "TAACATC"), c("five_prime_utr", "CDS", "three_prime_utr", "5UTR-CDS", "5UTR_start30"), 
                            "rna-binding_protein_mrna_motif", gene_set = gene_set,
                            dir_out = "2024.emt.rprof/YBX2B-motif", fname_prefix = "emt.rprof.YBX2B-motif")
#list_tests$tdf
list_out <- get_heatmap(list_tests$tmat, vec_color_group = NULL, type_col = "dlog10p",
                        #row_pattern="^(?!.*translationONLY.*)",
                        col = colorRamp2(c(-5,-1,0,1,5),c("#0000ff", "#ffffcc", "#ffffcc", "#ffffcc", "#ff0000")),
                        cluster_rows = T, column_title='YBX2B-motif',
                        fontsize_row_names=9, fontsize_column_names=9, column_name_angle=50)
fname  <-  sprintf("YBX2B-motif_%s", list_out$type_col_short )
print_figure(list_out$list_ht, width = 4.25, height = 2.5, file = fname)



list_tests <- perform_tests(c(motif_name = "YBX2C-motif", motif = "GCCANACCAYCGC"), c("five_prime_utr", "CDS", "three_prime_utr", "5UTR-CDS", "5UTR_start30"), 
                            "rna-binding_protein_mrna_motif", gene_set = gene_set,
                            dir_out = "2024.emt.rprof/YBX2C-motif", fname_prefix = "emt.rprof.YBX2C-motif")
#list_tests$tdf
list_out <- get_heatmap(list_tests$tmat, vec_color_group = NULL, type_col = "dlog10p",
                        #row_pattern="^(?!.*translationONLY.*)",
                        col = colorRamp2(c(-5,-1,0,1,5),c("#0000ff", "#ffffcc", "#ffffcc", "#ffffcc", "#ff0000")),
                        cluster_rows = T, column_title='RBX2C-motif',
                        fontsize_row_names=9, fontsize_column_names=9, column_name_angle=50)
fname  <-  sprintf("YBX2C-motif_%s", list_out$type_col_short )
print_figure(list_out$list_ht, width = 4.25, height = 2.5, file = fname)
...
################
#Top Motif H. Su 
list_tests <- perform_tests(c(motif_name = "TOP-HSU-motif", motif = "CYYYYYBBBBB"),
                            c("five_prime_utr", "CDS", "three_prime_utr", "5UTR-CDS", "5UTR_start30"),
                            "rna-binding_protein_mrna_motif", gene_set = gene_set, 
                            dir_out = "2024.emt.rprof/TOP-HSU", fname_prefix = "emt.rprof.TOP")

list_out <- get_heatmap(list_tests$tmat, vec_color_group = NULL, type_col = "dlog10p",
                        #row_pattern="^(?!.*translationONLY.*)",
                        col = colorRamp2(c(-5,-1,0,1,5),c("#0000ff", "#ffffcc", "#ffffcc", "#ffffcc", "#ff0000")),
                        cluster_rows = T, column_title='TOP-HSU-motif',
                        fontsize_row_names=9, fontsize_column_names=9, column_name_angle=50)
fname  <-  sprintf("TOP-HSU-motif_%s", list_out$type_col_short )
print_figure(list_out$list_ht, width = 4.25, height = 2.5, file = fname)
...
## YBX1 BCTGCG from R Transite database
list_tests <- perform_tests(c(motif_name = "YBX1-motif", motif = "BCTGCG"),
                            c("five_prime_utr", "CDS", "three_prime_utr", "5UTR-CDS", "5UTR_start30"),
                            "rna-binding_protein_mrna_motif", gene_set = gene_set, 
                            dir_out = "2024.emt.rprof/YBX1", fname_prefix = "emt.rprof.TOP")

list_out <- get_heatmap(list_tests$tmat, vec_color_group = NULL, type_col = "dlog10p",
                        #row_pattern="^(?!.*translationONLY.*)",
                        col = colorRamp2(c(-5,-1,0,1,5),c("#0000ff", "#ffffcc", "#ffffcc", "#ffffcc", "#ff0000")),
                        cluster_rows = T, column_title='YBX1-motif',
                        fontsize_row_names=9, fontsize_column_names=9, column_name_angle=50)
fname  <-  sprintf("YBX1-motif_%s", list_out$type_col_short )
print_figure(list_out$list_ht, width = 4.25, height = 2.5, file = fname)



################################################################################
## Rename tiff folder name
################################################################################
...
# New directory path
new_dir <- paste0(old_dir, "2024_emt_rprof")

# Move old with new 
system2("mv", args = c(old_dir, new_dir))
...
#####################################################
#####################################################
save.image("2024_emt_rprof.Rdata")

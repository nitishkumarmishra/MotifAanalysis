...
my_data = csv_files |> 
  ...
  filter(abs(dlog10p) >= 2) |> # P-value <= 0.001
  ...
  mgsub::mgsub(pattern = c("TISU","GGAGG", "GGC-rich", "PRTE", "CERT", "TOP","CUbox", "YBX2A", "YBX2C", "YBX1", "TOP_HSU", "YBX2B", "CU_box"), 
               replacement = c("TISU_motif_TISU","GGAGG_motif_GGAGG", "GGC-rich_motif_GGC-rich", "PRTE_motif_PRTE", "CERT_motif_CERT", "TOP_motif_TOP",
                 "CUbox_motif_CUbox", "YBX2A_motif_YBX2A", "YBX2C_motif_YBX2C", "YBX1_motif_YBX1", "TOP-HSU_motif_TOP", "YBX2B_motif_YBX2B", "CUbox_motif_CUbox"))
               #("GGAGG_motif_GGAGG", "TOP-motif_1_TOP-motif", "GCG-rich_1_GCG-rich","TISU_1_TISU", "CU_box_CUbox", "YBX1_1_YBX1", "TOP-HSU_HSU_TOP-HSU"))
...
#a3 <- sapply(strsplit(my_data_new$RBP_motif_name, "_"), function(x) ifelse(length(x) >= 3, x, x))
RBP_motif_all <- a3
...
utr3_RBPs_all_DEtranslation <- a3
...
save.image("HOMER_2024_After_3UTR_Results_Filter.RData")
